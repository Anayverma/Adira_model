...
from sklearn.metrics.pairwise import cosine_similarity #to measure the smlariity of two sentences
...
flag=True
print('Hello! I am Adira Chatbot. Start typing your issue. To end convo write bye!')
while(flag==True):
    user_response = input()
